...
public class LibSqlTypeMappingSource : RelationalTypeMappingSource
{
    ...
    private static readonly LibSqlByteArrayTypeMapping Blob = new(BlobTypeName);
    private static readonly LibSqlStringTypeMapping Text = LibSqlStringTypeMapping.Default;
    ...
    private readonly Dictionary<Type, RelationalTypeMapping> _clrTypeMappings = new()
    {
        ...
        { typeof(ulong), LibSqlULongTypeMapping.Default },
        { typeof(ushort), new UShortTypeMapping(IntegerTypeName) },
        { typeof(DateTime), LibSqlDateTimeTypeMapping.Default },
        { typeof(DateTimeOffset), LibSqlDateTimeOffsetTypeMapping.Default },
        { typeof(TimeSpan), new TimeSpanTypeMapping(TextTypeName) },
        { typeof(DateOnly), LibSqlDateOnlyTypeMapping.Default },
        { typeof(TimeOnly), LibSqlTimeOnlyTypeMapping.Default },
        { typeof(decimal), LibSqlDecimalTypeMapping.Default },
        { typeof(double), Real },
        { typeof(float), new FloatTypeMapping(RealTypeName) },
        { typeof(Guid), LibSqlGuidTypeMapping.Default },
        { typeof(JsonTypePlaceholder), LibSqlJsonTypeMapping.Default }
    };
