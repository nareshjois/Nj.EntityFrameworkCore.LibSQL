...
/// <summary>
///     LibSql-specific extension methods for <see cref="TableBuilder" />.
/// </summary>
public static class LibSqlTableBuilderExtensions
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-sqlite-returning-clause">Using the SQL RETURNING clause with LibSql</see> for more
    ...
    ///     certain LibSql features, such as virtual tables or tables with AFTER triggers.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-sqlite-returning-clause">Using the SQL RETURNING clause with LibSql</see> for more
    ///     information and examples.
