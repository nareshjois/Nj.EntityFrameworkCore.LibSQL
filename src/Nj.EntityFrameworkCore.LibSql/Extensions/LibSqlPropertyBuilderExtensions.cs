...
/// </remarks>
public static class LibSqlPropertyBuilderExtensions
{
    /// <summary>
    ...
    {
        propertyBuilder.Metadata.SetValueGenerationStrategy(LibSqlValueGenerationStrategy.Autoincrement);
    ...
    {
        columnBuilder.Overrides.SetValueGenerationStrategy(LibSqlValueGenerationStrategy.Autoincrement);
    ...
    public static IConventionPropertyBuilder? HasValueGenerationStrategy(
        ...
        LibSqlValueGenerationStrategy? strategy,
    ...
    public static bool CanSetValueGenerationStrategy(
        ...
        => propertyBuilder.CanSetAnnotation(
            LibSqlAnnotationNames.ValueGenerationStrategy, strategy, fromDataAnnotation);
