...
/// </remarks>
public static class LibSqlComplexTypePropertyBuilderExtensions
{
    /// <summary>
    ///     Configures the property to use the SQLite AUTOINCREMENT feature to generate values for new entities, 
    ///     when targeting SQLite. This method sets the property's value generation strategy to <see cref="LibSqlValueGenerationStrategy.Autoincrement" />.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and relationships</see>, and
    ///     <see href="https://aka.ms/efcore-docs-sqlite">Accessing SQLite databases with EF Core</see> for more information and examples.
