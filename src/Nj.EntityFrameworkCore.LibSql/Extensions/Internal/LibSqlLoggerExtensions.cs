...
namespace Nj.EntityFrameworkCore.LibSql.Internal;
...
public static class LibSqlLoggerExtensions
{
    ...
    {
        var definition = LibSqlResources.LogConflictingValueGenerationStrategies(diagnostics);
    ...
    private static string ConflictingValueGenerationStrategiesWarning(EventDefinitionBase definition, EventData payload)
    {
        ...
        return d.GenerateMessage(
            p.LibSqlValueGenerationStrategy.ToString(),
