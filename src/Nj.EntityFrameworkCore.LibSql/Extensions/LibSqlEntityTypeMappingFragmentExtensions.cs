...
/// </summary>
public static class LibSqlEntityTypeMappingFragmentExtensions
{
    /// <summary>
    ...
    public static bool IsSqlReturningClauseUsed(this IReadOnlyEntityTypeMappingFragment fragment)
        => fragment.FindAnnotation(LibSqlAnnotationNames.UseSqlReturningClause) is not { Value: false };
    ...
    public static void UseSqlReturningClause(this IMutableEntityTypeMappingFragment fragment, bool? useSqlReturningClause)
        => fragment.SetOrRemoveAnnotation(LibSqlAnnotationNames.UseSqlReturningClause, useSqlReturningClause);
    ...
    public static bool? UseSqlReturningClause(
        ...
        => (bool?)fragment.SetOrRemoveAnnotation(LibSqlAnnotationNames.UseSqlReturningClause, useSqlReturningClause, fromDataAnnotation)
            ?.Value;
    ...
    public static ConfigurationSource? GetUseSqlReturningClauseConfigurationSource(this IConventionEntityTypeMappingFragment fragment)
        => fragment.FindAnnotation(LibSqlAnnotationNames.UseSqlReturningClause)?.GetConfigurationSource();
}
