...
/// </remarks>
public static class LibSqlMigrationBuilderExtensions
{
    /// <summary>
    ...
    public static bool IsLibSql(this MigrationBuilder migrationBuilder)
        => string.Equals(
            migrationBuilder.ActiveProvider,
            typeof(LibSqlOptionsExtension).Assembly.GetName().Name,
