...
/// <summary>
///     Entity type extension methods for LibSql-specific metadata.
/// </summary>
/// <remarks>
///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and relationships</see>, and
///     <see href="https://aka.ms/efcore-docs-sqlite">Accessing LibSql databases with EF Core</see> for more information and examples.
/// </remarks>
public static class LibSqlEntityTypeExtensions
{
    /// <summary>
    ...
    {
        if (entityType.FindAnnotation(LibSqlAnnotationNames.UseSqlReturningClause) is { Value: bool useSqlOutputClause })
        {
    ...
    public static void UseSqlReturningClause(this IMutableEntityType entityType, bool? useSqlReturningClause)
        => entityType.SetOrRemoveAnnotation(LibSqlAnnotationNames.UseSqlReturningClause, useSqlReturningClause);
    ...
    public static bool? UseSqlReturningClause(
        ...
        => (bool?)entityType.SetOrRemoveAnnotation(
            LibSqlAnnotationNames.UseSqlReturningClause,
    ...
    public static ConfigurationSource? GetUseSqlReturningClauseConfigurationSource(this IConventionEntityType entityType)
        => entityType.FindAnnotation(LibSqlAnnotationNames.UseSqlReturningClause)?.GetConfigurationSource();
    ...
    public static bool IsSqlReturningClauseUsed(this IReadOnlyEntityType entityType, in StoreObjectIdentifier storeObject)
    {
        if (entityType.FindMappingFragment(storeObject) is { } overrides
            && overrides.FindAnnotation(LibSqlAnnotationNames.UseSqlReturningClause) is { Value: bool useSqlOutputClause })
        {
            return useSqlOutputClause;
        }
