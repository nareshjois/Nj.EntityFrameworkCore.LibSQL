...
namespace Nj.EntityFrameworkCore.LibSql.Internal
{
    ...
    public static class LibSqlStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Nj.EntityFrameworkCore.LibSql.Properties.LibSqlStrings", typeof(LibSqlStrings).Assembly);
...
namespace Nj.EntityFrameworkCore.LibSql.Internal
{
    ...
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Nj.EntityFrameworkCore.LibSql.Properties.LibSqlStrings", typeof(LibSqlResources).Assembly);
        ...
        /// <summary>
        ///     Both the LibSqlValueGenerationStrategy '{generationStrategy}' and '{otherGenerationStrategy}' have been set on property '{propertyName}' on entity type '{entityName}'. Configuring two strategies is usually unintentional and will likely result in a database error.
        /// </summary>
        ...
        {
            var definition = ((Diagnostics.Internal.LibSqlLoggingDefinitions)logger.Definitions).LogConflictingValueGenerationStrategies;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.LibSqlLoggingDefinitions)logger.Definitions).LogConflictingValueGenerationStrategies,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        LibSqlEventId.ConflictingValueGenerationStrategiesWarning,
                        LogLevel.Warning,
                        "LibSqlEventId.ConflictingValueGenerationStrategiesWarning",
