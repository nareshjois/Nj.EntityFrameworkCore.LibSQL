...
/// </summary>
public class LibSqlModelValidator : RelationalModelValidator
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        foreach (var entityType in model.GetEntityTypes())
        {
            ...
            {
                throw new InvalidOperationException(LibSqlStrings.StoredProceduresNotSupported(entityType.DisplayName()));
            }
        }
    }
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        if (propertySrid != duplicatePropertySrid)
        {
            throw new InvalidOperationException(
                LibSqlStrings.DuplicateColumnNameSridMismatch(
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        foreach (var mappedType in mappedTypes)
        {
            ...
            {
                throw new InvalidOperationException(
                    LibSqlStrings.IncompatibleSqlReturningClauseMismatch(
