...
///     Seeded from driver-contract findings (SQLite 3.45.1) so query/update
...
public static class LibSqlDatabaseCapabilities
{
    ...
    public static bool SupportsReturningClause
        // SQLite 3.35+ / libSQL. Nj.LibSql.Data drains RETURNING readers to
        // SQLITE_DONE so EF SaveChanges persists generated keys (C-002).
