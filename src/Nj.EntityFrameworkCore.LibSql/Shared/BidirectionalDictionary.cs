    ...
    where TValue : notnull
{
    ...
    ///     comparing keys, or null to use the default <see cref="IEqualityComparer{T}" /> for the type of the key.
    /// </param>
    /// <param name="valueComparer">
    ///     The <see cref="IEqualityComparer{T}" /> implementation to use when
    ///     comparing values, or null to use the default <see cref="IEqualityComparer{T}" /> for the type of the value.
    /// </param>
    ...
    /// </summary>
    public IEqualityComparer<TKey> KeyValueComparer
    ...
    ///     This method returns <see langword="false" /> if key is not found in the <see cref="BidirectionalDictionary{TKey, TValue}" />.
    /// </returns>
    ...
    /// <returns>
    ///     <see langword="true" /> if the <see cref="BidirectionalDictionary{TKey, TValue}" /> contains
    ...
    public bool ContainsValue(TValue value)
        => Inverse._dictionary.ContainsKey(value);
    ...
    /// <param name="value">The value of the element to add.</param>
    /// <returns>
    ///     <see langword="true" /> if the key/value pair was added to the <see cref="BidirectionalDictionary{TKey, TValue}" />
