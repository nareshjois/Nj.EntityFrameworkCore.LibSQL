...
public class LibSqlConventionSetBuilder : RelationalConventionSetBuilder
{
    ...
    public override ConventionSet CreateConventionSet()
    {
        ...
        conventionSet.Replace<ValueGenerationConvention>(new LibSqlValueGenerationConvention(Dependencies, RelationalDependencies));
        conventionSet.Replace<StoreGenerationConvention>(new LibSqlStoreGenerationConvention(Dependencies, RelationalDependencies));
