...
///     or were configured to use a <see cref="LibSqlValueGenerationStrategy" />.
...
/// </remarks>
public class LibSqlValueGenerationConvention : RelationalValueGenerationConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="LibSqlValueGenerationConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    /// <param name="relationalDependencies"> Parameter object containing relational dependencies for this convention.</param>
    public LibSqlValueGenerationConvention(
    ...
    {
        if (name == LibSqlAnnotationNames.ValueGenerationStrategy)
        {
...
#pragma warning restore EF1001 // Internal EF Core API usage.
    ...
    private static ValueGenerated? GetValueGenerated(
        ...
        => GetValueGenerated(property, storeObject)
            ?? (property.GetValueGenerationStrategy(storeObject, typeMappingSource) != LibSqlValueGenerationStrategy.None
