...
///     or using a <see cref="LibSqlValueGenerationStrategy" /> at the same time.
/// </summary>
/// <remarks>
...
/// </remarks>
public class LibSqlStoreGenerationConvention : StoreGenerationConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="LibSqlStoreGenerationConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    /// <param name="relationalDependencies"> Parameter object containing relational dependencies for this convention.</param>
    public LibSqlStoreGenerationConvention(
        ...
        IConventionContext<IConventionAnnotation> context)
    {
        ...
        switch (name)
        {
            ...
            case RelationalAnnotationNames.ComputedColumnSql:
                ...
                break;
            case LibSqlAnnotationNames.ValueGenerationStrategy:
    ...
    protected override void Validate(IConventionProperty property, in StoreObjectIdentifier storeObject)
    {
        if (property.GetValueGenerationStrategyConfigurationSource() != null)
        {
            ...
            if (generationStrategy != LibSqlValueGenerationStrategy.None)
            {
