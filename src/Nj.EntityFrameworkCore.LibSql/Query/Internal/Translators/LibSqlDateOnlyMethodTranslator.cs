...
/// </summary>
public class LibSqlDateOnlyMethodTranslator : IMethodCallTranslator
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public LibSqlDateOnlyMethodTranslator(LibSqlSqlExpressionFactory sqlExpressionFactory)
