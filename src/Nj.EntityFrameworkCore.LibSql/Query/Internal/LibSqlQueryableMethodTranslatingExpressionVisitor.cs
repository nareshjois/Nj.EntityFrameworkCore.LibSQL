...
/// </summary>
public class LibSqlQueryableMethodTranslatingExpressionVisitor : RelationalQueryableMethodTranslatingExpressionVisitor
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected LibSqlQueryableMethodTranslatingExpressionVisitor(
        LibSqlQueryableMethodTranslatingExpressionVisitor parentVisitor)
        : base(parentVisitor)
    {
    ...
    protected override QueryableMethodTranslatingExpressionVisitor CreateSubqueryVisitor()
        => new LibSqlQueryableMethodTranslatingExpressionVisitor(this);
        ...
        bool ascending)
    {
            ...
            || orderingExpressionType == typeof(ulong))
        {
            throw new NotSupportedException(
                LibSqlStrings.OrderByNotSupported(orderingExpressionType.ShortDisplayName()));
        }
...
#pragma warning restore EF1001
    ...
    protected override ShapedQueryExpression? TranslatePrimitiveCollection(
        ...
        string tableAlias)
    {
        // Support for JSON functions (e.g. json_each) was added in LibSql 3.38.0 (2022-02-22, see https://www.sqlite.org/json1.html).
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        // inferred later based on usage in LibSqlInferredTypeMappingApplier); we should be able to apply any SQL logic needed to convert
        ...
        // LibSqlInferredTypeMappingApplier, as if we had a parameter collection.
...
#pragma warning restore EF1001
        ...
        [NotNullWhen(true)] out SqlExpression? jsonValue)
    {
        ...
        {
            // See #36689
            throw new InvalidOperationException(LibSqlStrings.ExecuteUpdateJsonPartialUpdateDoesNotSupportUlong);
        }
...
#pragma warning restore EF9002
    ...
    public static SqlExpression ApplyJsonSqlConversion(
        ...
        LibSqlSqlExpressionFactory sqlExpressionFactory,
