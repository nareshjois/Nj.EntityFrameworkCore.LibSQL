...
/// </summary>
public class LibSqlQueryTranslationPostprocessor : RelationalQueryTranslationPostprocessor
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public LibSqlQueryTranslationPostprocessor(
    ...
    protected override Expression ProcessTypeMappings(Expression expression)
        => new LibSqlTypeMappingPostprocessor(Dependencies, RelationalDependencies, RelationalQueryCompilationContext).Process(expression);
    ...
    private sealed class ApplyValidatingVisitor : ExpressionVisitor
    {
        protected override Expression VisitExtension(Expression extensionExpression)
        {
            ...
            {
                throw new InvalidOperationException(LibSqlStrings.ApplyNotSupported);
            }
