...
| `Nelknet.LibSQL.Data` (runtime) | Soft-fork submodule [`external/Nelknet.LibSQL`](../external/Nelknet.LibSQL) → [nareshjois/Nelknet.LibSQL](https://github.com/nareshjois/Nelknet.LibSQL) `@b0a9c51` (upstream `0.2.10` + RETURNING drain + HTTP Hrana errors/baton + unprefixed parameter normalize) |
