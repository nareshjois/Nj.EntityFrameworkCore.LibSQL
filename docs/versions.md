...
| `Nelknet.LibSQL.Data` (runtime) | Soft-fork submodule [`external/Nelknet.LibSQL`](../external/Nelknet.LibSQL) → [nareshjois/Nelknet.LibSQL](https://github.com/nareshjois/Nelknet.LibSQL) `@8b5a289` (upstream [`0.2.11`](https://github.com/nelknet/Nelknet.LibSQL/releases/tag/v0.2.11) + soft-fork patches; see [adr/0001-soft-fork-nelknet.md](adr/0001-soft-fork-nelknet.md)) |
