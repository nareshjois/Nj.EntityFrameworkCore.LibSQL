...
public abstract class GraphUpdatesLibSqlTestBase<TFixture>(TFixture fixture) : GraphUpdatesTestBase<TFixture>(fixture)
    where TFixture : GraphUpdatesLibSqlTestBase<TFixture>.GraphUpdatesLibSqlFixtureBase, new()
{
    [ConditionalTheory(Skip = "Default owned collection pattern does not work with LibSQL due to composite key.")]
    ...
    public abstract class GraphUpdatesLibSqlFixtureBase : GraphUpdatesFixtureBase
    {
        ...
        public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder)
            => base.AddOptions(builder.ConfigureWarnings(b => b.Ignore(LibSqlEventId.CompositeKeyWithValueGeneration)));
