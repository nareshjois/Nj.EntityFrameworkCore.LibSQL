...
public class LibSqlMigrationsSqlGeneratorTest() : MigrationsSqlGeneratorTestBase(
    LibSqlTestHelpers.Instance,
    new ServiceCollection(),
    LibSqlTestHelpers.Instance.UseProviderOptions(new DbContextOptionsBuilder()).Options)
{
    [ConditionalFact]
...
""");
    ...
    public void CreateTableOperation_with_annotations(bool autoincrement, string pkName)
    {
        ...
        if (autoincrement)
        {
            addIdColumn.AddAnnotation(LibSqlAnnotationNames.Autoincrement, true);
        }
    ...
    public virtual void AddColumnOperation_with_spatial_type()
    {
        Generate(
            new AddColumnOperation
            {
                Table = "Geometries",
                Name = "Geometry",
                [LibSqlAnnotationNames.Srid] = 4326,
...
""");
    ...
    public override void AddForeignKeyOperation_without_principal_columns()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation(nameof(AddForeignKeyOperation)), ex.Message);
    }

    public override void AlterColumnOperation_without_column_type()
    {
        var ex = Assert.Throws<NotSupportedException>(() => base.AlterColumnOperation_without_column_type());
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation(nameof(AlterColumnOperation)), ex.Message);
    }
    ...
    {
        var migrationBuilder = new MigrationBuilder("LibSql");
...
""");
    ...
    [ConditionalFact(Skip = "C-006: SpatiaLite / spatial types are out of scope (Preview 1).")]
...
""");
    ...
    public virtual void AddPrimaryKey_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("AddPrimaryKeyOperation"), ex.Message);
    }
    ...
    public virtual void AddUniqueConstraint_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("AddUniqueConstraintOperation"), ex.Message);
    }
    ...
    public virtual void AddCheckConstraint_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("AddCheckConstraintOperation"), ex.Message);
    }
    ...
    public virtual void DropForeignKey_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("DropForeignKeyOperation"), ex.Message);
    }
    ...
    public virtual void DropPrimaryKey_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("DropPrimaryKeyOperation"), ex.Message);
    }
    ...
    public virtual void DropUniqueConstraint_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("DropUniqueConstraintOperation"), ex.Message);
    }
    ...
    public virtual void DropColumn_throws_when_no_model()
    {
        ...
        Assert.Equal(LibSqlStrings.InvalidMigrationOperation("DropColumnOperation"), ex.Message);
    }
