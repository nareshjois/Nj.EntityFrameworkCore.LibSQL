...
public class StringTranslationsLibSqlTest : StringTranslationsRelationalTestBase<BasicTypesQueryLibSqlFixture>
{
    public StringTranslationsLibSqlTest(BasicTypesQueryLibSqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
public class BasicTypesQueryLibSqlFixture : BasicTypesQueryFixtureBase, ITestSqlLoggerFactory
{
